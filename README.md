...
OpenVault is a re-implementation of Fallout 1 Engine, trying to match at maximum with the same original gameplay, fidelity, engine bugfixes, and some quality of life improvements, that works (mostly) hassle-free on multiple platforms.
